...
/* harmony export */   "diffTimes": () => (/* binding */ diffTimes)
/* harmony export */ });
...
function diffTimes(now, end, selector) {
    const diff = end.diff(now).toObject();
    document.getElementById(selector).innerHTML = luxon__WEBPACK_IMPORTED_MODULE_0__.Duration.fromObject(diff).toFormat('hh:mm:ss');
};
...
/* harmony export */ });
/* harmony import */ var _diffSet_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./diffSet.js */ "./src/diffSet.js");
...
function handleCalcDates(event) {
    ...
    if (firstDate && secondDate) {
        const diff = (0,_diffSet_js__WEBPACK_IMPORTED_MODULE_0__.diffDates)(firstDate, secondDate); // 3
        console.log(diff);
        dateCalcResult.innerHTML = (0,_diffSet_js__WEBPACK_IMPORTED_MODULE_0__.diffToHtml)(diff); // 4
    }
    else dateCalcResult.innerHTML = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.formatError)("Для расчета промежутка необходимо заполнить оба поля"); // 5
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setStateBtn": () => (/* binding */ setStateBtn)
/* harmony export */ });
/* harmony import */ var _timerSet_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timerSet.js */ "./src/timerSet.js");
...
startBtn.addEventListener("click", (event) => {
    ...
    timeInterval = setInterval(() => {
        (0,_timerSet_js__WEBPACK_IMPORTED_MODULE_0__.timerSet)(timeInterval);
    }, 1000);    
...
function setStateBtn(stateStartBtn, stateStopBtn) {
...
/* harmony import */ var _diffSet_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./diffSet.js */ "./src/diffSet.js");
...
let now = luxon__WEBPACK_IMPORTED_MODULE_3__.DateTime.local().set({ milliseconds: 0 }),
    end = {};
...
timerHours.addEventListener('input', () => {
    ...
    if (timerHours.value != "" && typeof(+timerHours.value) === 'number' && timerHours.value > 0) {
        (0,_timer_js__WEBPACK_IMPORTED_MODULE_2__.setStateBtn)(false, true); 
        end = now.plus({ hour: timerHours.value });
    }
    else {
        (0,_timer_js__WEBPACK_IMPORTED_MODULE_2__.setStateBtn)(true, true)
    };
});
...
function timerSet(timeInterval) {
    (0,_diffSet_js__WEBPACK_IMPORTED_MODULE_1__.diffTimes)(now, end, 'timer__value');
